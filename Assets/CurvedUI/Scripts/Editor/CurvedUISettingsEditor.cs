...
#pragma warning restore 414
        ...
        void OnEnable()
		{
            ...
            #if !CURVEDUI_UNITY_XR && !UNITY_2021_1_OR_NEWER
        ...
        public override void OnInspectorGUI()
        {
            ...
            {            
                ...
                if (GUILayout.Button(loadingCustomDefine ? "Please wait..." : "Clear all Custom Defines") && !loadingCustomDefine)
                    SwitchToDefine("");
                ...
                if (GUILayout.Button("Open in web browser")) OpenDocs();
                GUILayout.EndHorizontal();
...
#region CUSTOM GUI ELEMENTS
        void DrawControlMethods()
        {
            ...
            switch (CurvedUIInputModule.ControlMethod)
            {
                ...
                case CurvedUIInputModule.CUIControlMethod.OCULUSVR:
                {
                    ...
                    //GUILayout.Label("Hand Interaction support disabled. OVR Interaction package missing.", EditorStyles.helpBox);
                    #endif
                    //hand property
                    CurvedUIInputModule.Instance.UsedHand = (CurvedUIInputModule.Hand)EditorGUILayout.EnumPopup("Hand", CurvedUIInputModule.Instance.UsedHand);
                    //button property
        ...
        void Draw180DegreeWarning()
        {
            GUILayout.BeginHorizontal();
            GUILayout.Space(150);
            EditorGUILayout.HelpBox("Canvas with angle bigger than 180 degrees will not be interactable. \n" +
    ...
    void SwapEventSystem()
        {
            ...
            if (system != null && !(system is CurvedUIEventSystem))
            {
